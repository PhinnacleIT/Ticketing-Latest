        ...
        <form class="export-tickets" enctype="multipart/form-data" method="post">
            ...
            <div class="filter-export mb-showtimes-filter">
                <select name="ticket_status" id="ticket_status">
                    <option value=""><?php esc_html_e( 'Ticket status', 'moviebooking' ); ?></option>
                ...
                <select name="checkin_status" id="checkin_status">
                    <option value=""><?php esc_html_e( 'Checkin status', 'moviebooking' ); ?></option>
                    <option value="checked-in"><?php esc_html_e( 'Checked in', 'moviebooking' ); ?></option>
                    <option value="not-checked-in"><?php esc_html_e( 'Not checked in', 'moviebooking' ); ?></option>
                </select>
