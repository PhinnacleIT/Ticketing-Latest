	  		...
	  		<table style="width: 100%; border-collapse: collapse;" >
				...
				<tr class="ticket2">
					<td>
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php if(substr($ticket['seat'],0,2)=='Op') {echo 'Open';} elseif(substr($ticket['seat'],0,2)=='VP') {echo 'VIP';} elseif(substr($ticket['seat'],0,2)=='SP') {echo 'Sponsor';} elseif(substr($ticket['seat'],0,2)=='GA') {echo 'General';}?>
						</div>
					</td>
					...
					<div style="color: <?php echo $ticket['color_label_ticket']; ?>">
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php if(substr($ticket['seat'],0,2)=='Op') {echo 'Free Seating';} else {echo substr($ticket['seat'],strrpos($ticket['seat'], '-')+1,1);}  ?>
						</div>
					</td>
					<td>
					<div style="color: <?php echo $ticket['color_label_ticket']; ?>">
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php if(substr($ticket['seat'],0,2)=='Op') {echo 'Free Seating';} else {echo substr($ticket['seat'],strrpos($ticket['seat'], '-')+2);}  ?>
						</div>
					</td>
				</tr>				
			</table>
...
<!--<img src="http://ticketing.phinnacleit.com/wp-content/uploads/2023/02/Moira.png" />-->
	<p style="text-align:center;">
		<img src="http://ticketing.phinnacleit.com/wp-content/uploads/2026/07/Beks-Chicago-page-Small.jpg" class="center"/>
	</p>
<!-- Description Ticket -->
