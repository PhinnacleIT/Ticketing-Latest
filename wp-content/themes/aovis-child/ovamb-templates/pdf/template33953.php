	  		...
	  		<table style="width: 100%; border-collapse: collapse;" >
				...
				<tr class="ticket2">
					<td>
						...
						<div style="color: <?php echo $ticket['color_content_ticket']; ?>">
							<!-- Ticket Number -->
							<?php if(substr($ticket['seat'],0,2)=='Op') {echo 'General';} elseif(substr($ticket['seat'],0,2)=='VP') {echo 'VIP';} elseif(substr($ticket['seat'],0,2)=='SV') {echo 'SVIP';} ?>
						</div>
					</td>
...
<!--<img src="http://ticketing.phinnacleit.com/wp-content/uploads/2023/02/Moira.png" />-->
	<p style="text-align:center;">
		<img src="http://ticketing.phinnacleit.com/wp-content/uploads/2026/04/PKH-2026.jpg" class="center"/>
	</p>
<!-- Description Ticket -->
